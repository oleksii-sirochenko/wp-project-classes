...
class Template_Loader {
	 ...
	 */
	public function __construct( $dir_path, $template_path = '' ) {
	 ...
	 * @return string
	 */
	public function get_template( $file_name, $path_from_template, array $args = array() ) {
	 ...
	 * @return string
	 */
	public function get_template_as_string( $file_name, $path_from_template, array $args = array() ) {
		ob_start();
